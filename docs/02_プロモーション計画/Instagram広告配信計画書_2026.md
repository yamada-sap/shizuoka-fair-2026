...
- **対象配信地域**：静岡市、焼津市、藤枝市、富士市、島田市、吉田町、牧之原市、富士宮市の8市町（**現在地に居住・滞在するユーザーに限定**）
  - ※他都市への誤配信（無駄打ち）を防ぐため、半径30kmなどの円形ジオフェンスではなく、**8市町の行政境界をピンポイントで包含指定**し、関心エリアユーザーは除外して配信外エリアを完全に排除します。
- **対象年齢・性別**：25歳〜45歳、男女（お出かけを決定する夫婦両層へのリーチ）
- **配信スケジューリング**：11/21〜11/29の直前お出かけ検討期において、木曜〜日曜日に予算配分を自動傾斜（+20〜30%）
- **トラッキングURL**：`?utm_source=instagram&utm_medium=cpa&utm_campaign=meta_2026`（公式LP遷移時）
...
- **境界ロック**：ただし、配信エリアである「静岡市、焼津市、藤枝市、富士市、島田市、吉田町、牧之原市、富士宮市」の8市町については、AIが拡張配信しないよう**地域ターゲット設定レベルで厳格にロック（固定・現在地限定）**します。これにより、他都市への無駄な配信をゼロにしつつ、指定エリア内でのターゲティング精度を最大化します。

### ② クリエイティブ主導のターゲティング（Creative-Led Targeting）

細かな興味関心セグメントの絞り込みに依存せず、クリエイティブ自体にターゲットをフィルタリングさせる手法を導入します。

- 広告クリエイティブの冒頭3秒以内のテロップ（例：「静岡ママ・パパ必見」「無料お出かけ」）や動画内の視覚情報をMetaのAIが解析し、関心のあるユーザーへ優先的に自動マッチングします。
...
- **入稿手順**：
  1. 提携インフルエンサー（`@shizuoka_info`, `@shizuokaosanponikki`）のMeta Business Suiteより、静鉄アド・パートナーズ（SAP）宛てに「広告パートナー連携許可」を申請・承認。
  2. インフルエンサー側でタイアップ投稿を公開後、投稿の「パートナーシップ広告コード（連携コード）」を発行してもらう。
  3. SAPの広告管理画面で当該コードを入力し、インフルエンサー名義の広告として入稿する。
...
> ＼静岡ママ・パパ必見！今週末の無料お出かけスポット／ 🎒✨
> 11/28(土)・29(日)にツインメッセ静岡で開催される「産業フェアしずおか2026」に行ってきました！
>
> 巨大な木のジャングルジムやプラモデル工作など、子どもが夢中になる体験がパワーアップ！
> 暖房完備の屋内だから雨や寒さも気にせず1日中楽しめますよ🙌
>
> 📍 ツインメッセ静岡（北館・南館）
> 🗓 11/28(土)・29(日) 10:00〜16:00
> 🎫 入場無料
>
> 会場マップや臨時駐車場情報は、プロフィール（ @shizuoka_info / @shizuokaosanponikki ）のリンクからチェックしてね🔗
>
> #産業フェアしずおか2026 #ツインメッセ静岡 #静岡お出かけ #静岡ママ #静岡子育て #入場無料イベント

#### コピー案2【地元グルメ・食い倒れ訴求】

> ＼静岡の「美味しい」が大集合！11/28(土)・29(日)ツインメッセへ／ 🐟🍚🍓
> 絶品グルメと特産品を満喫できる年に一度の祭典「産業フェアしずおか2026」が開幕！
>
> 目の前で繰り広げられる「冷凍マグロの裁断ショー」や、名物しらす丼、山梨・長野から届く限定グルメなど、お腹いっぱい楽しめるブースがたくさん！
> 臨時駐車場もあるから、家族みんなでドライブがてら出かけてみてね🚗
> 詳細はプロフィールリンクから🔗
>
> #静岡グルメ #しらす丼 #マグロ裁断ショー #静岡イベント #産業フェアしずおか2026 #ツインメッセ静岡

#### コピー案3【週末お出かけ・タイパ重視訴求】

> 「次の週末どこ行こう？」と悩んでるママ・パパ必見！👀
...
最新のMeta広告配信最適化（CPM 420〜450円、CPC 30〜52円）を前提とし、**①直接WEBアクション指標（クリック・LP閲覧）** と **②認知波及（ビュースルー来場＋口コミ拡散）を含めた総合集客インパクト** の2軸で試算しています。

### 広告配信・Webアクション基本シミュレーション

| 項目 | コラボブースト（キャンペーンA） | 公式直接（キャンペーンB） | 合計（加重平均・想定値） |
| :--- | :--- | :--- | :--- |
...
| **想定獲得クリック数（LP/プロフ遷移）**| 1,200 〜 1,960 Clicks | 720 〜 1,320 Clicks | **1,920 〜 3,280 Clicks** |
| **想定CPC（クリック/LP遷移単価）** | 28円 〜 45円 | 34円 〜 62円 | **30円 〜 52円** |

---

### 総合来場集客インパクト（ビュースルー・波及効果込み）

入場無料イベントにおいては、広告をクリックせずに認知・記憶して当日来場する「ビュースルー層」や「口コミ・家族間共有」が全体の約8割以上を占めます。

| 指標項目 | 試算ロジック・根拠 | 想定数値・結果 |
| :--- | :--- | :--- |
| **① 直接クリック来場世帯数** | 獲得クリック数（約2,500件）× 直接CVR（3%〜5%） | **75 〜 125 世帯** |
| **② ビュースルー＆口コミ来場世帯数** | 表示回数（約23万回）の 0.04%〜0.07% が波及来場 | **90 〜 175 世帯** |
| **想定総集客数（ファミリー層）** | ① ＋ ② の合算 | **165 〜 300 世帯（約500〜1,000人）** |
| **実質獲得CPA（1世帯あたり）** | 予算100,000円 ÷ 想定総集客世帯数 | **333円 〜 606円 / 世帯** |

* ※企画書の単独目標値 **「300,000回表示」** に対し、平均シナリオ値で **230,947回（達成率約77%）** を確保します。
* ※キャンペーンA（ブースト）は、提携インフルエンサーの既存オーディエンスに対する信頼性を活かせるため、クリック率（CTR）および獲得クリック単価（CPC）においてキャンペーンB（公式直接）より高い効率が期待されます。
...
- **ペルソナ配慮・スマホ操作UX（認知摩擦の低減）の徹底（新規追加）**：
  - 子育て世代がベビーカーを押しながらなどの片手操作（親指タップ）でタイムラインを流し見することを想定し、**「1投稿・1メッセージ」**に要素を絞り込みます。
  - 最重要テロップ（「入場無料」「ツインメッセ静岡」等）は文字サイズを大きく強調し、**1秒で情報が脳内に伝わるクリエイティブ**を徹底します。
  - 広告から送客する公式サイト特設LPのファーストビューは情報量を整理し、遷移後の認知摩擦による直帰（離脱）リスクを排除します。
