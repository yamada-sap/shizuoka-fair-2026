...
- **片手操作UI/UX・認知摩擦の排除（ペルソナレビュー反映）**：子育て世代がベビーカーを押しつつ、スマートフォンを片手操作（親指タップ）で閲覧するシーンを想定した設計とする。
  - **「1投稿・1メッセージ」**に要素を絞り込み、情報過多による離脱を防ぐ。
  - 最重要情報（「ツインメッセ静岡」「入場無料」等）は文字サイズを極力大きく強調し、**1秒で視覚的に情報が伝わるレイアウト**を徹底する。
  - 投稿から送客する公式サイト特設LPのファーストビュー情報量を整理し、遷移後の認知摩擦による直帰リスクを排除する。
...
## 2.5 プレ運用（8月・9月先行運用）の非実施方針

本番告知前の先行プレ運用（8月・9月中の投稿・運用開始）は実施しません。
これは、以下のリスクを排除するためのプロデューサー（最終決裁者）判断に基づく決定です。
* **リアリティの欠如とエンゲージメント低下リスク**：地場体験コーナーの詳細写真等、本番のリアルな素材・画像が手元にない段階（素材〆切は10月7日）で見切り発車をした場合、イラストやフリー素材中心の投稿が続いて公式アカウントの「お出かけのワクワク感」が薄れ、ファミリー層のエンゲージメント率が低下するリスクを完全に防ぎます。
* **運用負荷の最適化**：無駄なプレ運用期間を廃止し、本番の告知・認知開始（10月15日）にリソースを集中させることで、効率的かつ高クオリティな発信を実現します。

公式Instagramアカウントの投稿開始は、イベント公式ビジュアルおよび出展者の詳細情報が確定し、新静岡駅13面マルチビジョン広告放映と連動する **10月15日（告知・認知期 / 第1フェーズ）** からとします。
...
- **公式Instagram運用代行費用**: **210,000円（税込）**
  - ※提携インフルエンサー2名のアサイン・タイアップ費用（220,000円）は別枠にて確保。
...
- **10月22日（木）**：【ステージ豪華ゲスト公開】ポムポムプリン30周年スペシャルステージ「ぱぴぷぺPom！」（シナモロール出演＆フォトセッション）の情報とタイムスケジュール解禁。
...
- **11月2日（月）**：【親子で楽しむモノづくり・伝統工芸】職人さんに教わる木工・体験コーナーや手仕事の実演、職人の技に触れる出展内容と事前予約・整理券情報を紹介。
- **11月6日（金）**：【山・海・里の恵み・静岡グルメ】農家直送の新鮮野菜（農業ゾーン）や「しずまえ鮮魚（水産業ゾーン）」の注目出展品目・グルメ紹介。
...
- **11月24日（火）**：【事前登録でプレゼント】Googleフォームを活用した「来場者アンケート一体型デジタルスタンプラリー（4,500名様に当たる！）」の参加方法と、景品情報を公開。
- **11月26日（木）**：【準備進行中！会場潜入リール】ツインメッセ静岡で設営が進む様子のタイムラプス・ショート動画を投稿。
- **11月27日（金）前日夜**：【明日開幕！最終お出かけチェックリスト】「入場無料」「雨天決行（全館屋内開催）」「ベビーカー置き場・授乳室あり」を強調し、持ち物や会場マップをおさらい。

---

## 8. コピペで使える最強の投稿原稿ドラフト

### ① 【Reels用台本 ＆ キャプション】親子で遊べる「モノづくり・体験コーナー」紹介

- **映像構成（約25秒）**
  - [0-3秒] 冒頭フック：子どもが工作体験で自分の作品を嬉しそうに見せる笑顔のアップ（中央に太文字「入場無料！週末どこ行く？ツインメッセ静岡へ！」）
  - [4-10秒] 伝統工芸の職人さんが優しく教える木工体験・手仕事の実演シーン
  - [11-17秒] ポムポムプリン＆シナモロールのステージ映像・写真撮影の様子
  - [18-22秒] 農山漁村の旨いもの・しずまえ海鮮・中部横断道物産ストリートのシズルカット
  - [23-25秒] エンディング：「11月28日(土)〜29日(日) ツインメッセ静岡でお待ちしています！」の画面
- **BGM**：Instagramビジネスライブラリ内のアコースティックポップ音源（商用利用可能）

#### キャプション本文

> 【入場無料】「できた！見て！」親子で手仕事・モノづくり体験を楽しもう！🪵🌾✨
>
> 静岡の産業・伝統工芸・美味しいものがツインメッセ静岡に大集合！
> 今年は子どもから大人まで夢中になれる体験コーナーがいっぱいです👇
>
> 🌲 ① 林業・木工体験
> 木の香りに包まれて、職人さんと一緒に挑戦する木工・工作体験コーナー！
>
> 🌾 ② 農業・水産業ゾーン
> 静岡の農家さんの新鮮野菜や、しずまえの豊かな海の幸を直接見て触れ合えます！
>
> 🎨 ③ 伝統工芸・地場産業ゾーン
> 駿河竹千筋細工や漆器など、職人技を間近で見学・体験！自分で作った作品は思い出のお土産に持ち帰れますよ🎒
>
> 🐶 ④ サンリオ30周年スペシャルステージ
> ポムポムプリン＆シナモロールがやって来る！無料観覧＆フォトセッションもあります✨
>
...
> ---
>
> #静岡イベント #静岡市イベント #親子お出かけ #子育て静岡 #産業フェアしずおか2026 #ツインメッセ静岡 #ポムポムプリン #入場無料
